...
/* defined LV_MEM_CUSTOM in lv_rt_thread_conf.h */
#else
...
#if defined (__RTTHREAD__)
/* defined LV_TICK_CUSTOM in lv_rt_thread_conf.h */
#else
...
#if defined (__RTTHREAD__)
/* defined LV_ASSERT_HANDLER_INCLUDE in lv_rt_thread_conf.h */
/* defined LV_ASSERT_HANDLER in lv_rt_thread_conf.h */
#else
...
#if defined (__RTTHREAD__)
/* defined LV_SPRINTF_CUSTOM in lv_rt_thread_conf.h */
#else
...
#if defined (__RTTHREAD__)
/* defined LV_ATTRIBUTE_MEM_ALIGN in lv_rt_thread_conf.h */
#else
